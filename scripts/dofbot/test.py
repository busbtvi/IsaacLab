"""
LIVESTREAM=2 PUBLIC_IP=10.126.36.101 ./isaaclab.sh -p scripts/dofbot/main.py --enable_cameras
"""
...
class DofBotSceneCfg(InteractiveSceneCfg):
    ...
    cube: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(0.0, 0.15, 0.0),                         # 바닥(z=0) 위에 놓이게 중심을 0.015m로
        ),
    )
    camera = CameraCfg(
        ...
        offset=CameraCfg.OffsetCfg(pos=(0.510, 0.0, 0.015), convention="ros"),
    )
